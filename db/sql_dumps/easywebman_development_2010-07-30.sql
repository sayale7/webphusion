...
# Generation Time: 2010-07-30 20:06:29 +0200
# ************************************************************
...
CREATE TABLE `item_data_contents` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `item_data_id` int(11) DEFAULT NULL,
  `name` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
# Dump of table item_datas
# ------------------------------------------------------------

DROP TABLE IF EXISTS `item_datas`;

CREATE TABLE `item_datas` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
